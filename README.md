...
소켓 프로그래밍을 이용하여 서버와 클라이언트가 서로 메시지를 주고받으며 동작하는 화투패를 이용한 카드게임입니다. 20장의 화투패에서 각자 총 3장의 카드를 받고 배팅하여 누가 족보가 더 높은지 승부하는 게임입니다. 
...
# 게임 방법
기존의 3장을 이용한 섯다게임과 규칙이 똑같습니다. 먼저 2장의 화투패를 받고 둘 중 공개할 패를 정합니다. 모두 정하였으면 배팅을 하거나 죽습니다. 모두 배팅이 끝나면 패를 한 장 더 받고 계속 배팅한 후에 마지막에 3장 중에 어떠한 족보로 낼지 2장을 고르고 승부합니다. 
